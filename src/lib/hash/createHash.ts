 ...
 */
export const createHashFromFile = async (filePath: FilePathLikeTypes, algorithm: AllHashAlgorithms = 'sha256', digest: BinaryToTextEncoding = 'hex'): Promise<string> => {
 ...
 */
export const createHashFromFileSync = (filePath: FilePathLikeTypes, algorithm: AllHashAlgorithms = 'sha256', digest: BinaryToTextEncoding = 'hex'): string => {
  const path = pathLikeToFilePath(filePath)
